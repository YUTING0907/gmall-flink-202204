...
public class ProductStatsApp {
    public static void main(String[] args)throws Exception {
        ...
        //TODO 3.将7个流统一数据格式
        ////进来一条数据很有可能写多条数据出去，所以用flatmap
        ////利用hashSet是因为一个订单里，下单不同店的同一个sku id，需要去重
        ////去重方案：1.存状态？不太好设置状态的时间 2.hashset
        ...
        SingleOutputStreamOperator<ProductStats> productStatsWithWMDS = unionDS.assignTimestampsAndWatermarks(WatermarkStrategy.<ProductStats>
